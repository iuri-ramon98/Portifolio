...
<html>
    ...
    <button ><a href="<?php echo BASE_URL; ?>topico/adicionarTopico/<?php echo $etapa['id']; ?>">ADICIONAR</a></button>
...
<div class="topicos">
	...
	<?php foreach($topicos as $item): //para cada registro retornado do banco?>
		<div class="menu">
			...
			<button ><a href="<?php echo BASE_URL; ?>arquivo/index/<?php echo $item['id']; ?>"><?php echo $item['id']; ?> - <?php echo $item['nome']; ?></a></button>
            <button ><a href="<?php echo BASE_URL; ?>topico/editarTopico/<?php echo $item['id']; ?>">EDITAR</a></button>
